def sub_seq(word):
    ...
    Kiedy wywala mi ValueError to znaczy, że coś się zwaliło i mamy pustą listę counters i oznacza to, że to ten przypadek, gdzie każda literka występuje po sobie tylko raz i
